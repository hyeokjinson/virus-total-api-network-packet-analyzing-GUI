...
apikey = '26f229251d36b1e527cb39199514d69479312580a5c3b04a602414575e518fd8'  #### ENTER API KEY HERE ####
...
try:
    rfile = open('results.txt', 'w+', newline='')
...
try:
    ...
    with open('log.txt', 'r') as infile:  # keeping the file open because it shouldnt
